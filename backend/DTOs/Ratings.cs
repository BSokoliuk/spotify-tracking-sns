...
public class CreateRateSongResponse
{
    public bool Success { get; set; }
    public string Message { get; set; } = string.Empty;
    public required SongRating SongRating { get; set; }
}

public class HighestRatedSongsResponse
{
    public List<AverageRatedSong> HighestRatedSongs { get; set; } = [];
    public bool Success { get; set; }
}

public class HighestRatedAlbumsResponse
{
    public List<AverageRatedAlbum> HighestRatedAlbums { get; set; } = [];
    public bool Success { get; set; }
}

public class HighestRatedArtistsResponse
{
    public List<AverageRatedArtist> HighestRatedArtists { get; set; } = [];
    public bool Success { get; set; }
}
