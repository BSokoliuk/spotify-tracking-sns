    ...
    <div class="w-full flex flex-col bg-[#313338] text-[#f2f3ea]">
      ...
      >
        ...
        <h2 class="mt-2 text-2xl">
          See most popular and liked music powered by users listening history
        </h2>
        ...
        <A
          href="/register"
          class="border border-[#f2f3ea] px-2 py-1 rounded-xl hover:shadow-inner hover:text-[#2b2d31] hover:bg-[#f2f3ea] transition-all duration-150"
        >
          Get Started
        </A>
      </div>
      <div class="flex">
              ...
              topProfiles().map((profile) => {
                return (
                  <tr class="">
                    <td>
                      <A
                        href={`/user/${profile.userName}/main`}
                        class="w-12 h-12"
                      >
                        <img
                    ...
                    <td>
                      <A href={`/user/${profile.userName}/main`} class="mr-2">
                        {profile.userName}
                      </A>
                    </td>
        ...
        <div class="w-1/2 px-4 py-4 text-xl border-l-2 border-[#f2f3ea] flex flex-col flex-grow">
          ...
          <span class="font-bold">
            {globalScrobbleCount() != null && globalScrobbleCount().count}
          </span>{" "}
          scrobbles)))
        </div>
      </div>
